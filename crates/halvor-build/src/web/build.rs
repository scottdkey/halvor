// Web application build (Rust server + SolidJS frontend)
...
/// Build web application (Rust server + SolidJS frontend)
pub fn build_web(release: bool) -> Result<()> {
    println!("Building web application...");

    // Step 0: Generate API client libraries
    ...
    // Step 2: Build the SolidJS frontend
    println!("Building SolidJS frontend...");
    ...
    execute_command(npm_cmd, "SolidJS build failed")?;
    ...
    println!("  - SolidJS app: projects/web/build/");
    println!("  - TypeScript API client: projects/web/src/lib/halvor-api/client.ts");
    println!("\nTo run the server:");
