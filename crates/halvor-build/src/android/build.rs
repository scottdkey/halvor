...
use crate::common::{copy_file, ensure_dir_exists, execute_command};
...
pub fn build_android() -> Result<()> {
    ...
    println!("Generating Kotlin API client library...");
    let workspace_root = std::env::current_dir()?;
    halvor_web::client_gen::generate_all_clients(&workspace_root)?;
    println!("✓ Kotlin API client library generated");
    ...
    let jni_libs = PathBuf::from("projects/android/src/main/jniLibs");
    ...
    let gradle_dir = PathBuf::from("projects/android");
