...
// NOTE: Config-dependent functions moved to halvor-core
// These require halvor_core::config::HostConfig which creates circular dependency
// Functions moved: impl From<HostInfoRow> for HostConfig, get_host_config, store_host_config, delete_host_config
