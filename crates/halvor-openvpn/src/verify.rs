...
pub fn verify_vpn(hostname: &str, env_config: &config::EnvConfig) -> Result<()> {
    println!("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
    ...
    let exec = Executor::new(hostname, env_config)?;
    let target_host = exec.target_host(hostname, env_config)?;
...
fn verify_vpn_with_executor(hostname: &str, target_host: &str, exec: &Executor) -> Result<()> {
    ...
    if halvor_docker::is_container_running(exec, "openvpn-pia")? {
